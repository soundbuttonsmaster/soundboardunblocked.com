...
export async function generateMetadata({
  ...
  const title =
    "Sign Up - Create Your Sound Buttons Account | SoundBoardUnblocked";
  const description =
    "Create a free SoundBoardUnblocked account to save favorites, upload custom sounds, create personalized soundboards, and share your favorite meme sounds with friends.";
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "SoundBoardUnblocked Sign Up",
        },
      ],
    },
    twitter: {
...
export default async function RegisterPage({
  ...
  const jsonLd = {
    ...
    "@type": "WebPage",
    name: "Sign Up",
    description: "Create a SoundBoardUnblocked account",
    url: `https://soundboardunblocked.com/${lang}/register`,
    isPartOf: {
      "@type": "WebSite",
