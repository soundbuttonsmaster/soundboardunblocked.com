...
export default function TrendingPageClient({ sounds, lang, dict }: Props) {
  ...
  const shouldCenterLastRow =
    displayedSounds.length % 51 === 0 ||
    (displayedSounds.length > 44 && (displayedSounds.length - 44) % 51 === 7);
